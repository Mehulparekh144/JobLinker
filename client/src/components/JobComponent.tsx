...
const JobComponent:React.FC<PropsType> = ({title , company , type , salary , location, applicants, date, experience}) => {
  return (
    <div className='bg-gray-100 w-full md:w-[32.5%] p-6 rounded-lg text-main border-2 border-main'>
      ...
      <div className="flex items-center justify-start gap-4 font-bold my-2 font-secondary">
      <p>{type}</p>
      ...
      <button className='w-max bg-transparent text-main font-bold hover:bg-second  transition ease-soft-spring'>View details</button>
      </div>
