...
const NavbarComponent = () => {
    ...
    return (
        <div className={`sticky top-2 flex justify-center my-2 `}>
            <div className='font-primary w-max text-main h-16 flex gap-6   items-center justify-evenly rounded-lg shadow-md bg-background border-2 px-16 border-main'>
                <div className='md:hidden'>
                    ...
                    <motion.div className={`${isMenuOpen ? 'block' : 'hidden'} h-screen -my-2 absolute px-4 bg-white/80 backdrop-blur-3xl top-0 left-0  w-screen transition-all duration-300 flex flex-col justify-start  items-start py-4 gap-3 z-50`}
